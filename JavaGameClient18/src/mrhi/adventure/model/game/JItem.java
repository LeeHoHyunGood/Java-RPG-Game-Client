...
public class JItem implements Cloneable{
	...
	public JItem(JItem jItem) {
		...
		item_value = jItem.getItem_value();
	}
	
	public JItem(ItemVO itemVO) {
		item_idx = itemVO.getItem_idx();
		own_idx = itemVO.getOwn_idx();
		gen_idx = itemVO.getGen_idx();
		item_type = itemVO.getItem_type();
		item_name = itemVO.getItem_name();
		item_job = itemVO.getItem_job();
		item_level = itemVO.getItem_level();
		item_power = itemVO.getItem_power();
		item_mPower = itemVO.getItem_mPower();
		item_str = itemVO.getItem_str();
		item_dex = itemVO.getItem_dex();
		item_int = itemVO.getItem_int();
		item_pro = itemVO.getItem_pro();
		item_maxHp = itemVO.getItem_maxHp();
		item_maxMp = itemVO.getItem_maxMp();
		item_speed = itemVO.getItem_speed();
		item_value = itemVO.getItem_value();
		x = itemVO.getX();
		y = itemVO.getY();
	}
	...
	public ItemVO getItemVO() {
		...
		itemVO.setItem_value(item_value);
		return itemVO;
	}
